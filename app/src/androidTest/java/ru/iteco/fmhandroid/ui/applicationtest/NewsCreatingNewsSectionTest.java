...
public class NewsCreatingNewsSectionTest extends NewsCreatingNewsSectionBasic {
    ...
    @Test
    @DisplayName("Проверка поле Категория разделе Создание новости")
    @Description("Проверяем поле Категория Проверяем работоспособность выбора категорий")
    ...
    @Test
    @DisplayName("Проверка не заполненых полей в разделе Создание новости")
    @Description("В разделе Создание новости проверка не заполненых полей. Проверка кнопки Отмена")
    ...
    @Test
    @DisplayName("Проверка полей в разделе Создание новости")
