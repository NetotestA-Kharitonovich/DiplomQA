...
public class NewsEditingNewsSectionTest extends NewsEditingNewsSectionBasic {
    ...
    @Test
    @DisplayName("Проверка поля Заголовок в разделе Редактирование новости")
    @Description("Проверяем полe Заголовок и выбор категорий в поле Категория")
    ...
    @Test
    @DisplayName("Проверка полей в разделе Редактирование новости")
