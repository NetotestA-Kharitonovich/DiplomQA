...
public class DataHelper {
    ...
    public void changeRandomЕheYearMonthOfTheDayFaker() {
        int year = faker.number().numberBetween(2026, 2039);
    ...
    public void loginEditTextRandomNumberFaker() {
        int loginNumber = faker.number().numberBetween(1001, 1000000);
    ...
    public void passwordEditTextRandomNumberFaker() {
        int passwordNumber = faker.number().numberBetween(1001, 1000000);
